...
public class FFmpegPlayer {
	...
	native int getFrame(int[] handler, int[] texture);

	native int renderFrameNative() throws InterruptedException;

	native void releaseFrame();

	private native void seekNative(int position) throws NotPlayingException;

	public native int getVideoDurationNative();
	...
	public native void audioseekNative(int plusclock);
	...
	public Bitmap prepareFrame(int width, int height) {
		// Bitmap bitmap =
