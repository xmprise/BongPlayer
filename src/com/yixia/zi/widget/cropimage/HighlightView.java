...
class HighlightView {
	...
	public HighlightView(View ctx) {
		...
		if (HONEYCOMB_OR_GREATER) {
			disableHWAcceleration(mContext);
		}
	}

	private void init() {
		android.content.res.Resources resources = mContext.getResources();
		mResizeDrawableWidth = resources.getDrawable(R.drawable.cropimage_camera_crop_width);
		mResizeDrawableHeight = resources.getDrawable(R.drawable.cropimage_camera_crop_height);
		mResizeDrawableDiagonal = resources.getDrawable(R.drawable.cropimage_indicator_autocrop);
	}
