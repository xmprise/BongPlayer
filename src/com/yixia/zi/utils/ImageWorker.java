...
import com.example.bongplayer2.BuildConfig;
...
public abstract class ImageWorker {
	...
	private void executeTaskInParallel(Object data, BitmapWorkerTask task) {
		try {
			...
			Log.e("localRejectedExecutionException", e);
		}
	}
	...
	/**
	 * A custom Drawable that will be attached to the imageView while the work is
	 * in progress. Contains a reference to the actual worker task, so that it can
	 * be stopped if a new binding is required, and makes sure that only the last
